...
from app.templates import TEMPLATE_AGENT_GERADOR, TEMPLATE_AGENT_AVALIADOR, TEMPLATE_AGENT_GERADOR_AWS
...
@transcricao_bp.route('/gerar-perguntas/<nivel_certificacao>', methods=['POST'])
def gerar_perguntas_aws(nivel_certificacao):
    try:
        ...
        # Processar a resposta para gerar as perguntas
        perguntas = processar_resposta(resposta_texto)
